(function () {
    ...
    AuthenticationService.$inject = ['$http', '$cookieStore', '$rootScope', '$timeout', '$log', 'UserService'];
    function AuthenticationService($http, $cookieStore, $rootScope, $timeout, $log, UserService) {
        var service = {};
